...
import type { D1BillingAdapter, CreateInvoiceInput, CreateSettlementInput } from "../../infrastructure/src/billing/d1-billing.js";
...
export class CreateInvoiceHandler implements UseCaseHandler<CreateInvoiceInput, InvoiceRecord> {
  constructor(private readonly billing: D1BillingAdapter) {}
