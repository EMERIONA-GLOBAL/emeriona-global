...
export { D1PersistenceAdapter, D1_ADAPTER_VERSION } from './d1.js';
export type { D1DatabaseLike, D1StatementLike } from './d1.js';
export { PersistenceEntityRepository, PERSISTENCE_REPOSITORY_VERSION } from './repositories/persistence-repository.js';
...
export { D1OperationalCommerceAdapter, D1_OPERATIONAL_COMMERCE_VERSION } from './commerce/operational.js';
...
export { createFoundationRuntime, INFRASTRUCTURE_COMPOSITION_VERSION } from './composition.js';
export type { FoundationCompositionOptions, FoundationRuntime } from './composition.js';
export const STEP_68={name:'Infrastructure & Integration Adapter Foundation',version:'1.3.0',status:'EXECUTABLE_COMPOSITION',providerNeutral:true} as const;
