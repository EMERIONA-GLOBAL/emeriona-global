...
export interface Product {
  ...
  readonly ownerId: CatalogOwnerId;
...
export interface CatalogRepositoryPort {
  ...
  findService(id: ServiceId): Promise<Service | null>;
  saveService(service: Service): Promise<Service>;
  findCatalog(id: CatalogId): Promise<Catalog | null>;
  saveCatalog(catalog: Catalog): Promise<Catalog>;
}

export const CATALOG_DOMAIN_VERSION = "1.0.0" as const;
