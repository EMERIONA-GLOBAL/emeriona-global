...
export type ProductId=string & {readonly __brand:"ProductId"};export type ServiceId=string & {readonly __brand:"ServiceId"};export type CatalogId=string & {readonly __brand:"CatalogId"};export type CatalogOwnerId=string & {readonly __brand:"CatalogOwnerId"};
