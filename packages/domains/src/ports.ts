...
export interface ProductRepositoryPortV1 { findById(id: ProductId): Promise<Product | null>; findCategories(id: ProductId): Promise<readonly CatalogCategory[]>; save(entity: Product): Promise<Product>; }
export interface ServiceRepositoryPortV1 { findById(id: ServiceId): Promise<Service | null>; findCategories(id: ServiceId): Promise<readonly CatalogCategory[]>; save(entity: Service): Promise<Service>; }
