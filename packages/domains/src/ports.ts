...
import type { ProductId, Product, ServiceId, Service } from "./catalog.js";
import type { PartnerId, PartnerAccount, PartnerProduct, PartnerService } from "./partner.js";
...
export interface PartnerRepositoryPortV1 { findById(id: PartnerId): Promise<PartnerAccount | null>; save(entity: PartnerAccount): Promise<PartnerAccount>; }
export interface PartnerCatalogRepositoryPortV1 {
  saveProduct(entity: PartnerProduct): Promise<PartnerProduct>;
  saveService(entity: PartnerService): Promise<PartnerService>;
}
...
export const DOMAIN_REPOSITORY_PORTS_VERSION = "1.0.0" as const;
